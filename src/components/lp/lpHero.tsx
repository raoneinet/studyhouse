                ...
                <div className="mx-auto px-6 py-24 md:py-32 container">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="relative z-10 hidden md:flex items-center justify-center">
                                ...
                                <div className="bg-white rounded-2xl shadow-[0_20px_50px_rgba(103,53,188,0.15)] border border-gray-100 p-6 relative z-10">
                                    ...
                                    <div className="bg-white border border-gray-100 rounded-xl p-4 mb-4 shadow-sm">
                                        ...
                                        <div className="flex items-center gap-1.5 text-xs font-semibold text-purple-600">
                                            <div className="w-2 h-2 rounded-full bg-purple-600"></div> Em andamento
                                        </div>
                                    </div>
                            ...
                            {/* Glow effects */}
                            <div className="absolute -z-10 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] bg-[#6735BC] rounded-full blur-[100px] opacity-10"></div>
                        </div>
                    </div>
                </div>
            </section>
