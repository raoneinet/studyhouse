        ...
        <>
            <section className="py-24 px-6 bg-[#6735BC]">
                <div className="container mx-auto text-center">
                    ...
                    <button className="px-10 py-4 bg-white text-[#6735BC] rounded-2xl font-bold font-sans text-lg hover:bg-gray-50 transition-all shadow-lg shadow-black/10 hover:-translate-y-1">
