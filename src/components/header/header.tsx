        ...
        <header className="fixed top-0 left-0 right-0 z-50 py-4 px-10 bg-white/80 backdrop-blur-md border-b border-gray-100 transition-all">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center gap-8 text-sm font-bold font-sans text-gray-500">
                    <a href="#como-funciona" className="hover:text-[#f97316] transition-colors">Como funciona</a>
                    <a href="#recursos" className="hover:text-[#f97316] transition-colors">Funcionalidades</a>
                    <a href="#depoimentos" className="hover:text-[#f97316] transition-colors">Depoimentos</a>
                </div>

                {!user &&
                    <div className="flex items-center gap-6">
                        <FormDialog
                            title={<span className="text-sm font-bold font-sans hover:text-[#f97316] transition-colors">Login</span>}
                            form={<LoginForm />}
